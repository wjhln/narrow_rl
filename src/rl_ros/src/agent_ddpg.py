...
from networks_ddpg import ActorNetwork, CriticNetwork
import numpy as np
import rospy
...
class Agent:
    def __init__(self, alpha=0.001, beta=0.002, env=None,
                 ...
                 chkpt_dir='/home/idriver/simulation_ws/src/rl_ros/src/rl_ros/algorithms/DDPG/plots/models/',
                 load_path = '/home/idriver/simulation_ws/src/rl_ros/src/rl_ros/algorithms/DDPG/plots/good_models/model1/',
                 mem_path = '/home/idriver/simulation_ws/src/rl_ros/src/rl_ros/algorithms/DDPG/plots/memory/'):
        self.gamma = gamma
        self.tau = tau
    ...
    def save_models(self):
        ...
        self.target_actor.save_weights(self.chkpt_dir+'target_actor')
        self.critic.save_weights(self.chkpt_dir+'critic')
        self.target_critic.save_weights(self.chkpt_dir+'target_critic')
